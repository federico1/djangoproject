...
from .views import cart_views, student_views, course_views, subject_views, user_views
...
router.register(r'v2/user-profile', user_views.UserProfileView, basename="view_user_profile")
